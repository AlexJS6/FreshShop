...
exports.getMyAccount = (req, res, next) => {res.render('my-account', {page: 'Shop', menu: 'My Account'})};
exports.getShopDetail = (req, res, next) => {res.render('shop-detail', {page: 'Shop', menu: 'Shop Detail'})};
